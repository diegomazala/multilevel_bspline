...
int main(int argc, char *argv[])
{
    ...
    const std::string filename_Sd_0 = argv[2];
    const std::string filename_Sd_1 = argv[3];
    const std::string filename_cdm = argv[4];
    const std::string filename_out = argv[5];

    TriMesh mesh_sb, mesh_sd_0, mesh_sd_1, mesh_cdm;
    OpenMesh::IO::Options 
        mesh_cdm_io_opt,
        mesh_sb_io_opt,
    ...
    TriMesh& mesh_D0 = mesh_sd_0;
    TriMesh& mesh_SA = mesh_sb;
    ...
    for (; vit_cdm != mesh_cdm.vertices_end(); ++vit_SA, ++vit_cdm)
    {
